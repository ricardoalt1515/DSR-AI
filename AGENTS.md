...
**H2O Allegiant** is an AI-powered water treatment engineering platform that generates technical proposals using Pydantic-AI agents. The system is architected as a **multi-repo workspace** with independent deployment pipelines:
