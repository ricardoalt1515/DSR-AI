            ...
            <Card className="overflow-hidden border-dashed">
                <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-lg font-semibold text-muted-foreground">Financial Estimates</h3>
                    ...
                    {roi && (
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 mt-6 pt-4 border-t border-border">
                            <div className="text-center">
                                <p className="text-xs text-muted-foreground mb-1">Est. Investment</p>
                                <p className="text-base font-semibold text-foreground">{roi.investment}</p>
                            </div>
                            <ArrowRight className="h-4 w-4 text-muted-foreground hidden sm:block" />
                            <div className="text-center">
                                <p className="text-xs text-muted-foreground mb-1">Est. Revenue</p>
                                <p className="text-base font-semibold text-foreground">{roi.revenue}</p>
                            </div>
                            <ArrowRight className="h-4 w-4 text-muted-foreground hidden sm:block" />
                            <div className="text-center">
                                <p className="text-xs text-muted-foreground mb-1">Est. ROI</p>
                                <p className="text-base font-semibold text-foreground">{roi.percentage}</p>
                            </div>
                        </div>
                    )}
