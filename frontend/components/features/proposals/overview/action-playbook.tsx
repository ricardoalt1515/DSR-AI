...
import { AlertCircle, ArrowUpRight, CheckCircle, ClipboardList, ShieldAlert } from "lucide-react";
...
export function ActionPlaybook({ recommendations, risks }: ActionPlaybookProps) {
    return (
                                    ...
                                    return (
                                        <li key={idx} className="flex items-start gap-3">
                                            ...
                                            <span className={cn(
                                                ...
                                                severity === "high" ? config.text : "text-foreground/90"
                                            )}>
                                                {item}
                                            </span>
                                        </li>
